...
import HealthPlanDraftView from "../views/HealthPlanDraftView.vue";
import HealthPlanView from "../views/HealthPlanView.vue";
...
const router = createRouter({
  ...
  routes: [
    ...
    { path: "/health-plan", component: HealthPlanView, meta: { title: "健康计划", subtitle: "查看每日行动和打卡反馈" } },
    { path: "/health-plan/draft/:planId", component: HealthPlanDraftView, meta: { title: "自定义健康计划", subtitle: "逐日编辑饮食、运动和睡眠安排" } },
